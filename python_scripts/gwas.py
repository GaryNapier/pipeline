...
# bcftools csq -f ../refgenome/MTB-h37rv_asm19595v2-eg18.fa -g ../refgenome/MTB-h37rv_asm19595v2-eg18.gff ../vcf/PAKISTAN_ALL.filt.val.gt.g.vcf.gz -o ../vcf/PAKISTAN_ALL.filt.val.gt.g.ann.vcf.gz

# python python_scripts gwas.py --vcf ../vcf/PAKISTAN_ALL.filt.val.gt.g.vcf.gz --pheno-csv trans.csv --pheno-names trans_status 
